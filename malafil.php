...
$sql = "SELECT * FROM `common_discussions`
ORDER BY this_id DESC";	
...
$discussion_container .= '<div class="w3-display-container w3-margin w3-hover-sand" style="cursor:pointer;" onclick = window.location.replace(\'story.php?id=' . $id . '\')>   
          
            <div class="w3-card w3-white w3-round w3-margin w3-padding"><br>
             
                <img src="users/' . $avatar  . '" alt="' . $author . '" class="w3-left w3-circle w3-margin-right" style="width:60px;height:60px;">
...
if(!empty($_SESSION['user'])){
  ...
  $story_input_block = '<div class="w3-card w3-white w3-round w3-margin" id = "story_input_block"><br>
                    ...
                    <div class="w3-row w3-padding" style = "margin-top:-35px;">
                      <h3 class="w3-center">Заголовок</h3>
                       ...
                       oninput = "document.getElementById(\'story_text_input_container\').style.display=\'block\'">
                     <div id = "story_text_input_container" style = "margin-top:-10px;display:none">
...
if(!empty($_SESSION['user'])){
    ...
    $backward =  '<h6 class = "w3-left"><a href="user.php?zs=' . $author . '">Нахуй</a></h6>';
...
<meta name = "author" content = "Yopuman">

<meta property="og:title" content="Malafil"/>
<meta property="og:description" content="Хорошие истории просто"/>
<meta property="og:image" content="yp.png">
<meta property="og:type" content="article"/>
<meta property="og:url" content= "https://frendors.com/malafil.png" />
...
<div class="w3-container">
 <?php echo $backward; ?> 
<?php echo $vk; ?>
<h1 class = "w3-center" style = "position:relative;top:15px;word-wrap:break-word;">Malafil</h1>

<main class="w3-content" style="max-width:700px;" >
    <?php echo $story_input_block; ?>
     <?php echo $discussion_container; ?>
