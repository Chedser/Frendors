...
<section class="user__dialog">
    <div class="container">
			<div class="user__dialog__wrapper" id = "user_chat_messages">
<?php 
...
<td class = message_content>Нехуй чужие переписки читать, мудель</td>
</tr>
<tr>
<td></td>
</tr>
...
<div class = "dialog__btn__wrapper" style = "margin-left:10px">
<button type="button"  onclick = "send_message_inside_dialog()" class = "send__message__btn">Ахуенно</button>  
</div>

<div style = "margin-top:10px;margin-left:10px"><a href = "dialogs.php">Нахуй</a></div>
